...
#user_story[As a user, I want to be able to list stuff and auto count.]
#user_story[As a user, I want to be able to log in to the system, so that I can access my personal data.]
